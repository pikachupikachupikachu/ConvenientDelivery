...
public class SpecificSiteFragment extends BaseFragment<FragmentSpecificSiteBinding> implements SwipeRefreshLayout.OnRefreshListener, BaseRecyclerViewAdapter.OnItemClickListener<Order> {
