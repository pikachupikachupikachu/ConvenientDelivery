...
import com.pikachu.convenientdelivery.databinding.FragmentSpecificGoodsBinding;
...
public class GoodsSpecificFragment extends BaseFragment<FragmentSpecificGoodsBinding> implements SwipeRefreshLayout.OnRefreshListener, BaseRecyclerViewAdapter.OnItemClickListener<Order> {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_specific_goods;
    }
    ...
    private void initData() {
        ...
        query.addWhereEqualTo("isGoodsSpecific", true);
